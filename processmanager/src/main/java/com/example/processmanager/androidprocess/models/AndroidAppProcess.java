...
package com.example.processmanager.androidprocess.models;
...
public class AndroidAppProcess extends AndroidProcess {
    ...
    // However, individual package name parts may only startForceKill with letters.
    ...
    public static final class NotAndroidAppProcessException extends Exception {
        public NotAndroidAppProcessException(int pid) {
            super(String.format(Locale.getDefault(), "The process %d does not belong to any application", pid));
        }
    }
